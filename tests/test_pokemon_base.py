...
from pokemon import Charmander, Eevee, Gastly, Haunter, Squirtle
...
class TestPokemonBase(BaseTest):
    ...
    def test_level(self):
        ...
        e.level_up()
        self.assertEqual(e.get_level(), 3)
    ...
    def test_status(self):
        ...
        c2 = Charmander()
        c1.attack(c2)
        self.assertEqual(c2.statusEffect, "Burn")
        RandomGen.set_seed(0)
        s1 = Squirtle()
        s2 = Squirtle()
        s1.attack(s2)
        self.assertEqual(s2.statusEffect, "Paralysis")
