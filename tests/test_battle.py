...
class TestBattle(BaseTest):
    ...
    def draw_battle(self):
        RandomGen.set_seed(69)
        team1 = PokeTeam("Team 1", [1, 1, 1, 0, 0], 0, PokeTeam.AI.ALWAYS_ATTACK)
        team2 = PokeTeam("Team 2", [1, 1, 1, 0, 0], 0, PokeTeam.AI.ALWAYS_ATTACK)
        b = Battle(verbosity=0)
        res = b.battle(team1, team2)
        self.assertEqual(res, 0)

    def heal_forfit(self):
        RandomGen.set_seed(69)
        team1 = PokeTeam("Team 1", [100, 0, 0, 0, 0], 0, PokeTeam.AI.RANDOM)
        team2 = PokeTeam("Team 2", [100, 0, 0, 0, 0], 0, PokeTeam.AI.RANDOM)
        b = Battle(verbosity=0)
        res = b.battle(team1, team2)
        self.assertEqual(res, 0)
    ...
    def battle_2(self):
        ...
        team1 = PokeTeam("Team 1", [1, 1, 1, 1, 1], 0, PokeTeam.AI.RANDOM)
        team2 = PokeTeam("Team 2", [1, 1, 1, 1, 1], 0, PokeTeam.AI.RANDOM)
        b = Battle(verbosity=0)
        res = b.battle(team1, team2)
        self.assertEqual(res, 1)